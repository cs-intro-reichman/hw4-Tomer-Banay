...
public class ArrCharOps {
    ...
    */
    public static char[] concat(char[] arr1, char[] arr2) {
        ...
        for (int i = 0; i < arr1.length; i++) { //copy ch from arr1 to result
            result [i] = arr1[i];
        }
        for (int i = 0; i < arr2.length; i++) { //copy ch from arr1 to result
    ...
    public static char[] subArray(char[] arr, int beginIndex, int endIndex) {
        char  [] result2 = new char [endIndex - beginIndex];
        for (int i = beginIndex; i < endIndex; i++) {
            result2 [i - beginIndex] = arr[i];
        }
    ...
    public static int compareTo(String str1, String str2) {
        ...
        // if charchters equal and length
        return 0;
